...
preprocess = {
    ...
    'DICT_RELATIVELY_COLS': mapper_cols.DICT_WMO_RELATIVELY_COLS_ALL,
    'LIST_CUSTOMSCALER_COLS': mapper_cols.LIST_WMO_GET_DATA_ALL,
    'SCALER': preprocessing.MinMaxScaler(),
    'LIST_COLUMNSELECTOR_COLS_2': None,
...
predict = {
    ...
    'DICT_COLS_RENAMED_HUISHOUDEN_PIVOT': {'Eenouderhuishouden':'ouder_in_eenouderhuishouden_totaal_mannen_en_vrouwen',
                                     ...
                                     'Paar':'paar',
                                     'Particulier huishouden': 'persoon_in_particulier_huishouden_totaal_mannen_en_vrouwen'},
